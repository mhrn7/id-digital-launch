...
const Navbar = () => {
  ...
  const getCtaText = () => {
    switch (language) {
      case 'EN':
        return { desktop: 'Get in Touch', mobile: 'Contact', clientArea: 'Client Area' };
      case 'ES':
        return { desktop: 'Ponerse en Contacto', mobile: 'Contacto', clientArea: 'Área del Cliente' };
      default: // PT
        return { desktop: 'Entre em Contato', mobile: 'Contato', clientArea: 'Área do Cliente' };
    }
  };
      ...
      <header className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-black/95 backdrop-blur-sm shadow-lg' : 'bg-transparent'}`}>
        <div className="container-custom">
          <nav className="flex items-center justify-between h-16 md:h-20">
            ...
            {/* Language Toggle, Client Area & CTA - Desktop */}
