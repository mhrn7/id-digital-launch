  ...
  const services = [
    {
      ...
      description: language === 'PT' 
        ? 'Estratégias otimizadas para plataformas digitais com foco em conversão e resultados.' 
        : 'Optimized strategies for digital platforms focused on conversion and results.',
      icon: (
